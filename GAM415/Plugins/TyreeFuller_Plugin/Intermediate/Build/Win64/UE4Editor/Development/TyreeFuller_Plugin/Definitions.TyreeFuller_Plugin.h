...
#define ORIGINAL_FILE_NAME "UE4Editor-TyreeFuller_Plugin.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME GAM415
#define DEPRECATED_FORGAME DEPRECATED
#define TYREEFULLER_PLUGIN_API DLLEXPORT
