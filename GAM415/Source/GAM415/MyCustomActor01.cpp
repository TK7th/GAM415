...
#include "MyCustomActor01.h"


// Sets default values
AMyCustomActor01::AMyCustomActor01()
{
...
void AMyCustomActor01::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AMyCustomActor01::Tick(float DeltaTime)
{
...
void AMyCustomActor01::PostActorCreated()
{
...
void AMyCustomActor01::PostLoad()
{
	Super::PostLoad();
...
void AMyCustomActor01::GenerateMesh()
{
	...
	CreateMesh(FVector(75, 100, 10), Vertices, Triangles,
...
void AMyCustomActor01::CreateMesh(FVector BoxRadius, TArray <FVector> & Vertices, TArray <int32> & Triangles,
